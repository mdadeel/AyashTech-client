...
export default function AdminEditItem({ params }) {
    const { id } = use(params);
        ...
        <div className="min-h-screen bg-[#0a0a0a] text-white flex">
            ...
            <main className="flex-1 lg:ml-64">
                <header className="sticky top-0 z-30 bg-[#0a0a0a]/80 backdrop-blur-sm border-b border-neutral-800 px-6 py-4 flex items-center gap-4">
                    <Link href="/admin/products" className="p-2 rounded-lg hover:bg-neutral-800 transition-colors">
                ...
                <div className="p-6 max-w-2xl">
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div>
                            ...
                            {formData.image && (
                                <div className="mt-3 w-24 h-24 rounded-lg overflow-hidden bg-neutral-800">
